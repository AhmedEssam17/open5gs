...
n3ga_location_t* instantiate_n3ga_location(int include_optional) {
  ...
  if (include_optional) {
    n3ga_location = n3ga_location_create(
      ...
      0,
      nchf_convergedcharging_n3ga_location__UDP,
       // false, not to have infinite recursion
      ...
      "YQ==",
      nchf_convergedcharging_n3ga_location__DSL,
      "0"
    );
  } else {
    n3ga_location = n3ga_location_create(
...
void test_n3ga_location(int include_optional) {
    n3ga_location_t* n3ga_location_1 = instantiate_n3ga_location(include_optional);

	cJSON* jsonn3ga_location_1 = n3ga_location_convertToJSON(n3ga_location_1);
	printf("n3ga_location :\n%s\n", cJSON_Print(jsonn3ga_location_1));
	n3ga_location_t* n3ga_location_2 = n3ga_location_parseFromJSON(jsonn3ga_location_1);
	cJSON* jsonn3ga_location_2 = n3ga_location_convertToJSON(n3ga_location_2);
	printf("repeating n3ga_location:\n%s\n", cJSON_Print(jsonn3ga_location_2));
}
