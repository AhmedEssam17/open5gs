...
void test_cell_global_id(int include_optional) {
    cell_global_id_t* cell_global_id_1 = instantiate_cell_global_id(include_optional);

	cJSON* jsoncell_global_id_1 = cell_global_id_convertToJSON(cell_global_id_1);
	printf("cell_global_id :\n%s\n", cJSON_Print(jsoncell_global_id_1));
	cell_global_id_t* cell_global_id_2 = cell_global_id_parseFromJSON(jsoncell_global_id_1);
	cJSON* jsoncell_global_id_2 = cell_global_id_convertToJSON(cell_global_id_2);
