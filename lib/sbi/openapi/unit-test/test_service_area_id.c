...
void test_service_area_id(int include_optional) {
    service_area_id_t* service_area_id_1 = instantiate_service_area_id(include_optional);

	cJSON* jsonservice_area_id_1 = service_area_id_convertToJSON(service_area_id_1);
	printf("service_area_id :\n%s\n", cJSON_Print(jsonservice_area_id_1));
	service_area_id_t* service_area_id_2 = service_area_id_parseFromJSON(jsonservice_area_id_1);
	cJSON* jsonservice_area_id_2 = service_area_id_convertToJSON(service_area_id_2);
