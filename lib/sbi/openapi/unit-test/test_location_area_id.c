...
void test_location_area_id(int include_optional) {
    location_area_id_t* location_area_id_1 = instantiate_location_area_id(include_optional);

	cJSON* jsonlocation_area_id_1 = location_area_id_convertToJSON(location_area_id_1);
	printf("location_area_id :\n%s\n", cJSON_Print(jsonlocation_area_id_1));
	location_area_id_t* location_area_id_2 = location_area_id_parseFromJSON(jsonlocation_area_id_1);
	cJSON* jsonlocation_area_id_2 = location_area_id_convertToJSON(location_area_id_2);
