...
rat_freq_information_t* instantiate_rat_freq_information(int include_optional) {
  ...
  if (include_optional) {
    rat_freq_information = rat_freq_information_create(
      ...
      1,
      0,
      nchf_convergedcharging_rat_freq_information__NR,
...
void test_rat_freq_information(int include_optional) {
    rat_freq_information_t* rat_freq_information_1 = instantiate_rat_freq_information(include_optional);

	cJSON* jsonrat_freq_information_1 = rat_freq_information_convertToJSON(rat_freq_information_1);
	printf("rat_freq_information :\n%s\n", cJSON_Print(jsonrat_freq_information_1));
	rat_freq_information_t* rat_freq_information_2 = rat_freq_information_parseFromJSON(jsonrat_freq_information_1);
	cJSON* jsonrat_freq_information_2 = rat_freq_information_convertToJSON(rat_freq_information_2);
