...
void test_eutra_location(int include_optional) {
    eutra_location_t* eutra_location_1 = instantiate_eutra_location(include_optional);

	cJSON* jsoneutra_location_1 = eutra_location_convertToJSON(eutra_location_1);
	printf("eutra_location :\n%s\n", cJSON_Print(jsoneutra_location_1));
	eutra_location_t* eutra_location_2 = eutra_location_parseFromJSON(jsoneutra_location_1);
	cJSON* jsoneutra_location_2 = eutra_location_convertToJSON(eutra_location_2);
