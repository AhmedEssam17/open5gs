...
access_token_req_t* instantiate_access_token_req(int include_optional) {
  ...
  if (include_optional) {
    access_token_req = access_token_req_create(
      nchf_convergedcharging_access_token_req_GRANTTYPE_client_credentials,
      "0",
      nchf_convergedcharging_access_token_req__NRF,
      nchf_convergedcharging_access_token_req__NRF,
      "a",
      "0",
...
void test_access_token_req(int include_optional) {
    access_token_req_t* access_token_req_1 = instantiate_access_token_req(include_optional);

	cJSON* jsonaccess_token_req_1 = access_token_req_convertToJSON(access_token_req_1);
	printf("access_token_req :\n%s\n", cJSON_Print(jsonaccess_token_req_1));
	access_token_req_t* access_token_req_2 = access_token_req_parseFromJSON(jsonaccess_token_req_1);
	cJSON* jsonaccess_token_req_2 = access_token_req_convertToJSON(access_token_req_2);
