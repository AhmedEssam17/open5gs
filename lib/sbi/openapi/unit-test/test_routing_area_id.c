...
void test_routing_area_id(int include_optional) {
    routing_area_id_t* routing_area_id_1 = instantiate_routing_area_id(include_optional);

	cJSON* jsonrouting_area_id_1 = routing_area_id_convertToJSON(routing_area_id_1);
	printf("routing_area_id :\n%s\n", cJSON_Print(jsonrouting_area_id_1));
	routing_area_id_t* routing_area_id_2 = routing_area_id_parseFromJSON(jsonrouting_area_id_1);
	cJSON* jsonrouting_area_id_2 = routing_area_id_convertToJSON(routing_area_id_2);
