...
access_token_err_t* instantiate_access_token_err(int include_optional) {
  ...
  if (include_optional) {
    access_token_err = access_token_err_create(
      nchf_convergedcharging_access_token_err_ERROR_invalid_request,
      "0",
      "0"
    );
  } else {
...
void test_access_token_err(int include_optional) {
    access_token_err_t* access_token_err_1 = instantiate_access_token_err(include_optional);

	cJSON* jsonaccess_token_err_1 = access_token_err_convertToJSON(access_token_err_1);
	printf("access_token_err :\n%s\n", cJSON_Print(jsonaccess_token_err_1));
	access_token_err_t* access_token_err_2 = access_token_err_parseFromJSON(jsonaccess_token_err_1);
	cJSON* jsonaccess_token_err_2 = access_token_err_convertToJSON(access_token_err_2);
